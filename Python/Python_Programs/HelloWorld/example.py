...
# You can find your example.py file under C:/Users/<Your User Name>/Dropbox/<Your surname and first letter>/Task 3/example.py
...
# Inside it, write Python code to take in a user's name using input() and then print out the name. 
...
# Write a program to take in the user's address, using input.
# Also ask the user to input their name.
# Print out "The address for " followed by the user's name, followed by " is " and then their address on one line.
# For example:
